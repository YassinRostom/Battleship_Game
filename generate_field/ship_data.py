...
def has_ship(battlefield, cell):
    ...
    """
    return battlefield[(cell[1], convert(cell[0]))] is not None         # Return False ==> Cell is Empty (None)
...
def ship_size(battlefield, cell, is_convert=False):
    ...
    returns a length of the ship, a part of which is located in cell
    ...
    else:                                   # If the value is None, this would mean that no ships at this cell.
        return 0, 0
